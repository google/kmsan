...
static void memmove_from_page(char *to, struct page *page, size_t offset, size_t len)
{
...
static void memmove_to_page(struct page *page, size_t offset, const char *from, size_t len)
{
